...
map.getView().fit([3922864.597780, -2976138.491776, 6485391.187089, -1310696.601828], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Projet SOFF Madagascar : 
Les activités planifiées pour la modernisation et la réhabilitation des stations météorologiques</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (548 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Le projet SOFF planifie la mise en œuvre des activités suivantes : <br />-          Installation des deux nouvelles stations météorologiques automatiques terrestres : Ambatondrazaka et Arivonimamo ; <br />-          Remplacement des six stations météorologiques : Mahanoro, Farafangana, Antsohihy, Ranohira, Morombe et Tuléar ; <br />-          Réhabilitation des trois stations : Sambava, Besalampy et Maevatanana ; <br />-          Installation d’une nouvelle station Radio sondage (UA) : Antsiranana <br />-          Mise en place trois centres de Maintenance Régionale.';
            }
